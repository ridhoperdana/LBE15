<?php 
    ...
    $sql = "SELECT * FROM karya_lab WHERE kelas = $kelas";
        ...
        <div class="container" style="margin-top:4em;">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Application for <?php echo $kelas; ?> SD</h2>
            ...
            <?php foreach ($result as $r => $rows){ ?>
                <div class="col-sm-4 portfolio-item">
                    <a href="halamankarya.php?id=<?php echo $rows['id_karya']; ?>" class="portfolio-link">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                        </div>
                        <img src="<?php echo $rows['gambar']; ?>" class="img-responsive" alt="">
                    </a>
                </div>
            <?php } ?>
            </div>
